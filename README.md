...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/perfplot-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13013&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/perfplot-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `perfplot` can be installed with:

```
conda install perfplot
```

It is possible to list all of the versions of `perfplot` available on your platform with:
